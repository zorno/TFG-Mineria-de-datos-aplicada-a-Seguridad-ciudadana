...
DROP SEQUENCE COMISARIA_seq;
DROP SEQUENCE HISTORIAL_COMISARIA_seq;
...
CREATE OR REPLACE TRIGGER COMISARIA_incr
BEFORE INSERT ON COMISARIA
FOR EACH ROW
BEGIN
  SELECT COMISARIA_seq.NEXTVAL
  INTO   :new.id_comisaria
  FROM   dual;
END;
/

CREATE OR REPLACE TRIGGER HISTORIAL_COMISARIA_incr
BEFORE INSERT ON HISTORIAL_COMISARIA
FOR EACH ROW
BEGIN
  SELECT HISTORIAL_COMISARIA_seq.NEXTVAL
  INTO   :new.id_his_comisaria
  FROM   dual;
END;
/